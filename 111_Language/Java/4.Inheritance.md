...
- ![](../../z_assets/Pasted_image_20230805100318.png)
...
- ![](../../z_assets/Pasted_image_20230805102317.png)
...
- For example:
	- ![](../../z_assets/Pasted_image_20230806131535.png)
...
- Use `instanceof` to check before casting from a superclass to a subclass.
	- ![](../../z_assets/Pasted_image_20230806132800.png)
- Note:
- ![](../../z_assets/Pasted_image_20230806132852.png)
...
- ![](../../z_assets/Pasted_image_20230806133448.png)
...
- ![](../../z_assets/Pasted_image_20230806155745.png)
...
- ![](../../z_assets/Pasted_image_20230806155904.png)
- `instanceof` returns true for all ancestors of a class.
- ![](../../z_assets/Pasted_image_20230806160412.png)
...
- ![](../../z_assets/Pasted_image_20230806161300.png)
- ![](../../z_assets/Pasted_image_20230806161200.png)
...
- ![](../../z_assets/Pasted_image_20230806174808.png)
...
- ![](../../z_assets/Pasted_image_20230806175025.png)
...
- ![](../../z_assets/Pasted_image_20230806181031.png)
- ![](../../z_assets/Pasted_image_20230806181058.png)
...
- ![](../../z_assets/Pasted_image_20230806181404.png)

# Methods with a variable number of parameters
- These are sometimes called `varargs` methods.
- ![](../../z_assets/Pasted_image_20230806184414.png)
- Note:
- ![](../../z_assets/Pasted_image_20230806184426.png)
- Here `printf` method is a `varargs` method.

# Enumeration Classes
- ![](../../z_assets/Pasted_image_20230806190037.png)
...
- You can obtain a instance of `Class` in 3 ways:
	- ![](../../z_assets/Pasted_image_20230806200631.png)
	- ![](../../z_assets/Pasted_image_20230806200901.png)
	- ![](../../z_assets/Pasted_image_20230806200924.png)
...
- ![](../../z_assets/Pasted_image_20230806201914.png)
- Create an instance of a class using the object of the `Class` like this:
- ![](../../z_assets/Pasted_image_20230806202146.png)

### Getting Resources
- ![](../../z_assets/Pasted_image_20230806202931.png)
- ![](../../z_assets/Pasted_image_20230806202952.png)
...
- ![](../../z_assets/Pasted_image_20230806205832.png)
- ![](../../z_assets/Pasted_image_20230806205858.png)
...
- Example:
- ![](../../z_assets/Pasted_image_20230806210333.png)
...
- Methods :
- ![](../../z_assets/Pasted_image_20230806210833.png)
...
5. Use polymorphism, not type information.
	1. ![](../../z_assets/Pasted_image_20230806185640.png)
